...
//		private var _skin:Object;
		...
		override public function handleEvent (event:Event) : void
		{
			switch(event.type)
			{
				case EventList.ISOSCENE_BUILDED :
				{
		...
		private function createAvatar ():void
		{
			...
			//sndFx = AudioHelper(facade.getObserver(AudioHelper.NAME)).addSound("sounds/fx/avatarFoot.mp3", false);
		}
...
//			component.stage.addEventListener(MouseEvent.CLICK, handleEvent, true);
			stage.addEventListener(MouseEvent.CLICK, handleEvent, true);
