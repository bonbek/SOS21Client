...
package ddgame.client.commands {
	 ...
	 *	@since  04.03.2008
	 */
	public class OverTileCommand extends Notifier implements ICommand {
		...
		public function execute (event:Event):void
		{
			...
			TileTriggersProxy(facade.getProxy(TileTriggersProxy.NAME)).launchTileTrigger(tile, MouseEvent.MOUSE_OVER);
		}
